...
class MemoryFs {
  constructor(_options) {
    ...
    _defineProperty(this, "rmdirSync", dirPath => {
      ...
      const _this$_resolve4 = this._resolve(dirPath),
    ...
    _defineProperty(this, "symlinkSync", (target, filePath, type) => {
      ...
      const _this$_resolve5 = this._resolve(filePath),
        dirNode = _this$_resolve5.dirNode,
        node = _this$_resolve5.node,
        basename = _this$_resolve5.basename;
    ...
    _defineProperty(this, "existsSync", filePath => {
      try {
        const _this$_resolve6 = this._resolve(pathStr(filePath)),
    ...
    _defineProperty(this, "unlinkSync", filePath => {
      ...
      const _this$_resolve9 = this._resolve(filePath, {
        ...
        basename = _this$_resolve9.basename,
        dirNode = _this$_resolve9.dirNode,
        dirPath = _this$_resolve9.dirPath,
    ...
    _defineProperty(this, "watch", (filePath, options, listener) => {
      ...
      const _this$_resolve10 = this._resolve(filePath),
    ...
    this.promises = PROMISE_FUNC_NAMES.filter(
      ...
      promises[funcName] = function() {
        ...
        return new Promise((resolve, reject) => {
          try {
            // $FlowFixMe: No indexer
            resolve(_this[`${funcName}Sync`].apply(_this, args));
          } catch (error) {
            reject(error);
          }
        });
  ...
  _open(filePath, flags, mode) {
    ...
    let _this$_resolve11 = this._resolve(filePath),
      dirNode = _this$_resolve11.dirNode,
      node = _this$_resolve11.node,
      basename = _this$_resolve11.basename,
      dirPath = _this$_resolve11.dirPath;
